...
class WebBot{
    ...
    */
    static registerMain(webMain, ip, port, options = {}){
        ...
        let browserParam = `{"serverIp":"${ip}", "serverPort":${port}, "browserName":"${browserName}", "debugPort":${debugPort}, "userDataDir":"${userDataDir}", "browserPath":"${browserPath}", "argument":"${argument}"}`;
