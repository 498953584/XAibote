...
async function webMain(webBot) {
    ...
    while (true) {
        ...
        for (var i = 0; i < 5; i++) {
            await webBot.goto("https://cn.bing.com/search?q=天气" + i);
            // await webBot.sendKeys('//*[@id="sb_form_q"]', '今天的天气' + i);
            // await webBot.sendVk(13);
            await webBot.clickElement('//*[@id="rh_meter"]');
            await webBot.setImplicitTimeout(2000);
        }
    }
    // //注入js代码并返回值
